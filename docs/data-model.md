...
- OMOP export `source_version` is a data-contract value reflecting the release that last changed the export shape (currently `3.5.0` — see `src/lib/omop-mapper.ts`), independent of the app version.
