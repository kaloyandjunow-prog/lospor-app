 ...
 */
export function useIntraopEventTimeline({ eventLog, startedAt, endedAt, onEventOps, legacyTimetable }: Args) {
  ...
  return { timetable, log, chartStartMs, nowMs, onTimetableChange, removeEvent, addEvents, commit }
}
