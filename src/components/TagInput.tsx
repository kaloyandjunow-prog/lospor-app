...
export type Tag = { label: string; sub?: string; code?: string; system?: string; labelEn?: string; labelBg?: string; inn?: string; atcCode?: string; group?: string; domain?: string; description?: string; source?: "manual" | "ai-scan" | "import" }
